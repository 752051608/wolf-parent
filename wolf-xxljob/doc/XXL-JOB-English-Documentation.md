...
The relative path of db scripts is as follows:
    ...
    /xxl-job/doc/db/scheduler_job_init_ddl.sql
...
<bean id="xxlJobExecutor" class="com.xxl.job.XxlJobExecutor" init-method="start" destroy-method="destroy" >
...
#### Step 1:develp obHandler in the executor project
    - 1, create new java class implent com.xxl.job.IJobHandler;
...
The scheduling center API service location: com.xxl.job.AdminBiz.java
